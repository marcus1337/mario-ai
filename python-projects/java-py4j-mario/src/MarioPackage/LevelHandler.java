...
public class LevelHandler {
	...
	public static String lvlsFolder = "";
	...
	public static String getLevel(String lvlName, int lvl){
		if(lvlName.equals("notchMedium"))
			return getExactLevel(lvlsFolder + "levels/notchMedium/" + "lvl-" + lvl + ".txt");
		return getExactLevel(lvlsFolder + "levels/notchParam/" + "lvl-" + lvl + ".txt");
	}
